    ...
    <main className="min-h-screen bg-white px-4 py-8">
      <div className="mx-auto max-w-3xl">
        ...
        <section className="mt-8 space-y-6 text-sm leading-relaxed text-gray-700" style={{fontFamily: 'Poppins, Sans-serif'}}>
          ...
          {/* Use of Service */}
          <div>
            <h2 className="font-semibold text-blue-600" style={{ fontFamily: "Poppins, Sans-serif", color: "#0068BB" }}>Use of Service</h2>
          ...
          {/* Accounts */}
          <div>
            <h2 className="font-semibold text-blue-600" style={{ fontFamily: "Poppins, Sans-serif", color: "#0068BB" }}>Accounts</h2>
          ...
          <div>
            <h2 className="font-semibold text-blue-600" style={{ fontFamily: "Poppins, Sans-serif", color: "#0068BB" }}>
              Intellectual Property
            </h2>
            <ul className="mt-2 list-disc space-y-1 pl-5" style={{fontFamily: 'Poppins, Sans-serif'}}>
              <li>
          ...
          {/* Data & Privacy */}
          <div>
            <h2 className="font-semibold text-blue-600" style={{ fontFamily: "Poppins, Sans-serif", color: "#0068BB" }}>Data & Privacy</h2>
            <ul className="mt-2 list-disc space-y-1 pl-5" style={{fontFamily: 'Poppins, Sans-serif'}}>
              <li>
          ...
          {/* Changes */}
          <div>
            <h2 className="font-semibold text-blue-600" style={{ fontFamily: "Poppins, Sans-serif", color: "#0068BB" }}>Changes to the Terms</h2>
            <ul className="mt-2 list-disc space-y-1 pl-5" style={{fontFamily: 'Poppins, Sans-serif'}}>
              <li>
